 ...
 */
final class Version20240207140802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vote (id INT AUTO_INCREMENT NOT NULL, session_id INT NOT NULL, tour INT NOT NULL, INDEX IDX_5A108564613FECDF (session_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
